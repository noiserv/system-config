...
<?php
  try  {
    ...
    elseif ($mode == "delete") {
      if ($type == "socorro"){// or $type == "entidade") {
    ...
    foreach($result as $row) {
      ...
      echo("</td><td align=\"CENTER\">");
      echo($row['nomeentidade']);
      echo("</td><td><a href=\"b3.php?mode=delete&type=socorro&id={$row['nummeio']}&id2={$row['nomeentidade']}\">delete</a></td></tr>\n");
      echo("</td></tr>\n");
    }
    echo("</table>\n");
    echo("<br><br><br>");
  ...
  echo("<a href='http://web.tecnico.ulisboa.pt/ist186474/testing/b3.php'> <button  class='btn btn-info' type='submit' value='Again'>Again</button></a>");
}
?>
